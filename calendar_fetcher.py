...
# captured for the news filter — primary: GBP/USD (Cable). Filter covers USD, GBP, EUR, JPY events.
...
def _is_forex_relevant(title: str, country: str, impact: str) -> bool:
    ...
    For GBP/USD forex trading
    (GBP_USD) any significant release for USD, GBP, EUR, JPY —
