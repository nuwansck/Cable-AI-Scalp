...
def load_settings() -> dict:
    ...
    settings.setdefault('bot_name', 'Cable AI Scalp v1.1')
    ...
    # AI News Guard defaults and optional Railway override.
    ...
    if env_ai_enabled is not None:
        settings['ai_news_guard_enabled'] = env_ai_enabled.strip().lower() in {'1', 'true', 'yes', 'on'}
